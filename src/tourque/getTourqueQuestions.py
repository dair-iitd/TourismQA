...
if(__name__ == "__main__"):
	...
	defaults["output_file_path"] = project_root_path / "data" / "tourque" / "crawled"/ "test_questions.json"
	defaults["log_file_path"] = project_root_path / "data" / "tourque" / "logs"/ "test_questions.log.json"
	...
	tourque_crawler = TourqueCrawler()
	tourque_crawler(input_file_path = Path(options.input_file_path), output_file_path = Path(options.output_file_path), log_file_path = Path(options.log_file_path))
